...
| Format | Ornek |
|--------|-------|
| `DD.MM.YYYY-DD.MM.YYYY ISIM TIP.xlsx` | `26.01.2026-30.01.2026 BURAK DEMIRALAY PLANLANAN ZIYARET.xlsx` |
| `DD-DD AY TIP ISIM.xlsx` | `26-30 OCAK HAFTALIK SIPARIS FORMU ERDI ALKAN.xlsx` |
